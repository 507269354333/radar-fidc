...
function extractPublications(row){
 ...
 for(const [field,raw] of Object.entries(row||{})){
   ...
   if(!/(URL|LINK|PROSPECT|LAMINA|ANUNC|COMUNIC|AVISO|DOCUMENT|MATERIAL)/.test(key))continue;
